...
var defaultPlacement = function (maxRow) { return new Array(maxRow).fill(0).map(function (_, i) {
    return ".yabee.placement-" + i + "{\n        top:" + 100 / 16 * i + "%;\n    }";
}).join("\n"); };
function html5renderer(options) {
    var containerEl = options.containerEl, videoEl = options.videoEl, _a = options.getBulletClassName, getBulletClassName = _a === void 0 ? function () { return ""; } : _a, _b = options.placement, placement = _b === void 0 ? defaultPlacement : _b, _c = options.maxRows, maxRows = _c === void 0 ? 16 : _c, _d = options.duration, duration = _d === void 0 ? 5 : _d;
